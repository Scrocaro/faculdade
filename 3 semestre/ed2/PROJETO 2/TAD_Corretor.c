...
Lista* arquivoParaLista(ALFATrie* dicionario, char* texto)  // dicionario e arquivo de texto -> retorna lista com palavras erradas
{
...
{
    Lista* palavrasErradas = arquivoParaLista(dicionario, "memposthumas_all.txt");
