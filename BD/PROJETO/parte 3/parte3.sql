...
INSERT
INTO	FUNCIONARIO(cpf_funcionario, rg, nome, idade, sexo, salario_hora)
VALUES  		   ("111.111.111-11", "11.111.111-1", "Acrinio Armani", 31, 'M', 8);	

	INSERT
	INTO	DEPENDENTES(cpf_funcion, nome, idade, custo, relacionamento)
	VALUES			   ("111.111.111-11", "Janaina Joana Armani", 28, 200.00, "Esposa");


INSERT
INTO	FUNCIONARIO(cpf_funcionario, rg, nome, idade, sexo, salario_hora)
VALUES  		   ("222.222.222-22", "22.222.222-2", "Ana Elena Cânovas", 20, 'M', 12);	

INSERT
INTO	FUNCIONARIO(cpf_funcionario, rg, nome, idade, sexo, salario_hora)
VALUES  		   ("333.333.333-33", "33.333.333-3", "Arlindo Toledo", 23, 'M', 10);	
